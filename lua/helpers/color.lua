...
function Color.__tostring(self) return self:to_css() end
...
---@return table Color
function Color.from_rgba(r, g, b, a) return Color.init(r / 0xff, g / 0xff, b / 0xff, a or 1) end
...
function Color.lighten(color, amount) return Color.from_hex(color):lighter(amount):to_css() end

function Color.darken(color, amount) return Color.from_hex(color):darker(amount):to_css() end

function Color.mix(a, b, amount) return Color.from_hex(a):blend(Color.from_hex(b), amount):to_css() end
